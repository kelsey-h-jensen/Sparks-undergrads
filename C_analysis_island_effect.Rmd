...
#ggplot
ggsave(filename = "INSPLATR_mgCgsoil.png", plot= amdu.C1, dpi = 300,  width = 6, height = 6, units = "in")
```
...
ggsave(filename = "INSPLATR_mgCgsoil.png", plot= lyan.C1, dpi = 300,  width = 6, height = 6, units = "in")
```
...
# exporting the ggplot
ggsave(filename = "INSPLATR_mgCgsoil.png", plot= lypa.C1, dpi = 300,  width = 6, height = 6, units = "in")
```
...
# exporting the ggplot
ggsave(filename = "INSPLATR_mgCgsoil.png", plot= plri.C1, dpi = 300,  width = 6, height = 6, units = "in")
```
